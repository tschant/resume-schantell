	...
	return (
		<div>
			...
			<ul className="list-disc pl-4">
				...
				<li>
					Resolved tickets that caused outages for enterprise companies within 4
					hours, while maintaining a 98% resolution rate.
				</li>
				<li>
					Reviewed Guardium application logs and Linux system logs to find root
					causes of issues within the Guardium application and services.
				</li>
			</ul>
			<div className="text-yellow-200">
			...
			<ul className="list-disc pl-4">
				...
				<li>Designed front-end user interface utilizing JavaScript and PHP.</li>
				<li>
